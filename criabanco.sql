CREATE DATABASE IF NOT EXISTS banco_farma;
USE banco_farma;
...
ALTER TABLE `Distribuidores`
  ADD CONSTRAINT Distribuidoras_usuario_FK FOREIGN KEY (usuario_id) REFERENCES `Usuario` (id)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Historico`
  ADD CONSTRAINT Historico_Cliente_FK FOREIGN KEY (Cliente_usuario_id) REFERENCES `Farmacia` (usuario_id)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Historico`
  ADD CONSTRAINT Historico_Distribuidoras_FK FOREIGN KEY (Distribuidores_usuario_id) REFERENCES `Distribuidores` (usuario_id)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Produtos`
  ADD CONSTRAINT Produtos_Distribuidoras_FK FOREIGN KEY (Distribuidores_usuario_id) REFERENCES `Distribuidores` (usuario_id)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Pedido`
  ADD CONSTRAINT pedido_Historico_FK FOREIGN KEY (Historico_Historico_ID) REFERENCES `Historico` (Historico_ID)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Pedido`
  ADD CONSTRAINT id_produto_Pedido FOREIGN KEY (Produtos_id_produto) REFERENCES `Produtos` (id_produto)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Promocao`
  ADD CONSTRAINT Produtos_table1 FOREIGN KEY (Produtos_id_produto) REFERENCES `Produtos` (id_produto)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Patrocinado`
  ADD CONSTRAINT Produtos_table2 FOREIGN KEY (Produtos_id_produto) REFERENCES `Produtos` (id_produto)
  ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE `Admin`
  ADD CONSTRAINT id_Admin FOREIGN KEY (Usuario_id) REFERENCES `Usuario` (id)
  ON DELETE NO ACTION ON UPDATE NO ACTION;
